...
public class List_profe  extends Activity implements AdapterView.OnItemClickListener {
    String x="FUNCIONA";
    TextView btn3;
    ...
    public static final Integer[] images = { R.drawable.inhabilitado,
            R.drawable.habilitado, R.drawable.habilitado, R.drawable.habilitado };
...
//                //"Item " + "fruit" + ": " + "k", Toast.LENGTH_SHORT);
