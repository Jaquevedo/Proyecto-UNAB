                    ...
                    if (noExisteCorreo) {
                        ...
                        db.collection("Personas").add(e).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                            ...
                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                Toast.makeText(RegistroEstudiante.this, "Estudiante " + c2 + " CREADO.", Toast.LENGTH_SHORT).show();
                                Intent intentProf = new Intent(RegistroEstudiante.this, RegistroExitoso.class);
                                startActivity(intentProf);
                            }
                        });
                    } else {
                        Toast.makeText(RegistroEstudiante.this, "Correo " + c1 + " ya existe.", Toast.LENGTH_SHORT).show();
                        Intent intentProf = new Intent(RegistroEstudiante.this, LoginActivity.class);
                        startActivity(intentProf);
                    }
